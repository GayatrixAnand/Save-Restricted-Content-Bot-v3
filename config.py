...
JOIN_LINK = os.getenv("JOIN_LINK", "https://t.me/New_Sanatani") # this link for start command message
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/The_Real_Anand")
